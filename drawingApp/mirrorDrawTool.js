function MirrorDrawTool() {
    ...
    // default size for stroke weight
    self.size = 1;
	...
	this.populateOptions = function() {
		select(".options").html(
			"<button class='BTN-tool' id='directionButton'>Make Horizontal</button><button class='BTN-tool' id='small'>Precise</button><button class='BTN-tool' id='medium'>Bold</button><button class='BTN-tool' id='large'>Heavy</button>");
        
		// click handler mirror button
